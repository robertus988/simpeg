...
class Data_suami_istri extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('admin/riwayat_keluarga/data_suami_istri', $data);
  ...
  public function tambah()
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar-admin');
      $this->load->view('templates/topbar', $data);
      $this->load->view('admin/riwayat_keluarga/data_suami_istri');
      $this->load->view('templates/footer');
      $this->load->view('templates/javascript');
    } else {
  ...
  public function edit($id)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar-admin');
      $this->load->view('templates/topbar', $data);
      $this->load->view('admin/riwayat_keluarga/edit_suami_istri', $data);
      $this->load->view('templates/footer');
      $this->load->view('templates/javascript');
    } else {
